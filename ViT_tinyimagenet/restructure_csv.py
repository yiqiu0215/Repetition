...
def main():
    data_dir = "/apps/users/lxy_xingyx/liuzhuanwei/Reproduce/datasets/tinyimagenet"
    json_path = "/apps/users/lxy_xingyx/liuzhuanwei/Reproduce/ViT_tinyimg/imagenet_class_index.json"
